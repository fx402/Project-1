                                    ...
                                    onChanged: (bool? value) {
                                      if (value == false) {
                                        setState(() {
                                          ...
                                          if (isCheckedHp == false &&
                                              isCheckedTV == false &&
                                              isCheckedRadio == false &&
                                              isCheckedKulkas == false) {
              ...
              child: Container(
                ...
                child: ElevatedButton(
                  style: ElevatedButton.styleFrom(
                      primary: colors, minimumSize: Size(size.width / 1.2, 40)),
                  onPressed: isCheckedHp == false &&
                          isCheckedTV == false &&
                          isCheckedRadio == false &&
                          isCheckedKulkas == false
                      ? () {
                      ...
                      : () async {
                          ...
                          userModel.poin = poin;
                          transactionModel.address = _address.text;
                          ...
                          notificationModel.title = "Transaksi";
                          notificationModel.description =
                              "Berhasil Transaksi dengan Menambah Poin $poin";
